...
class Trainer:
    def __init__(self, options):
        ...
        elif self.opt.model == "mpmono":
            self.models["encoder"] = networks.MPMono()

        elif self.opt.model == "smtmono":
            self.models["encoder"] = networks.smt_t(pretrained=True,
                                                    drop_path_rate=self.opt.drop_path)

        elif self.opt.model == "smtsmono":
            self.models["encoder"] = networks.smt_s(pretrained=True,
                                                    drop_path_rate=self.opt.drop_path)

        elif self.opt.model == "smtbmono":
            self.models["encoder"] = networks.smt_b(pretrained=True,
                                                    drop_path_rate=self.opt.drop_path)
            
        elif self.opt.model == "smtadapter":
            self.models["encoder"] = networks.SMTAdapter()
            self.models["encoder"].init_weights()
